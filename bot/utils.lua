...
function get_receiver_api(msg)
 ...
 function send_api_keyboard(msg, receiver, text, keyboard)
  local url_api = 'https://api.telegram.org/bot'.._config.api_key..'/sendMessage?chat_id='.. receiver..'&parse_mode=markdown&&text='..URL.escape(text)..'&disable_web_page_preview=true&reply_markup='..json:encode(keyboard)
